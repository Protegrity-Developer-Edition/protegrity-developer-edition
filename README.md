...
For more details about key features, refer to the [Protegrity AI Developer Edition documentation](http://10.39.2.239:7676/docs/about_dev/).
...
- [Python >= 3.10](https://www.python.org/downloads/)
    > **Note**: Ensure that the python command on your system points to a supported python3 version, for example, Python 3.10 or later. You can verify this by running `python --version`.
...
For more information about the minimum requirements, refer to [Prerequisites](http://10.39.2.239:7676/docs/install/deved_prereq/).
...
4.  Start the required services and obtain the necessary credentials.
    ...
    **Data Protection components where API registration is required:**
    ...
    1. Install the `protegrity-ai-developer-python` module.
        ...
        ```
        > **Note for UAT**: For UAT, checkout protegrity-ai-developer-python repository and install the module using the following command from the root of the repository.
        ```
        pip install .
        ```
...
- **AI Pack Samples with No API Registration Required**: Discover PII, Find and Redact, Data Discovery on Tabular Data, Semantic Guardrail, Anonymization, and Synthetic Data. These run locally against the AI Pack Docker containers.
    - [Data Discovery samples](http://10.39.2.239:7676/docs/prod_features/data_discovery/dd_using/)
    - [Semantic Guardrails samples](http://10.39.2.239:7676/docs/prod_features/sem_guard/sgr_using/)
    - [Synthetic Data samples](http://10.39.2.239:7676/docs/prod_features/synth_data/sd_using/)
    - [Anonymization samples](http://10.39.2.239:7676/docs/prod_features/anon/anon_using/)
- **Data Protection Samples with API Registration Required**: Find and Protect, Direct Protect or Unprotect from the CLI. These use the Protegrity-hosted API Service for tokenization, encryption, and protect/unprotect operations. Registration is also required for the online Jupyter notebook.
    - [Data Protection samples](http://10.39.2.239:7676/docs/prod_features/data_prot/prot_using/)
...
For more information about using Protegrity AI Developer Edition in agentic AI workflows, refer to the [Protegrity AI Developer Edition documentation](http://10.39.2.239:7676/).
...
For more information about moving from Protegrity AI Developer Edition to Protegrity AI Team Edition, refer to the [Promoting to AI Team Edition](http://10.39.2.239:7676/docs/migration/).
...
Keys:
- `named_entity_map`: Optional mappings (friendly labels) used during redact/mask. [Supported Classification Entities](http://10.39.2.239:7676/docs/entities/)
...
If you change published ports in the feature `docker-compose.yml`, update `endpoint_url`. Also, if required, update the semantic guardrail URL in the scripts.
...
- For more information about Synthetic Data, refer to the [Synthetic Data documentation]( http://10.39.2.239:4646/docs/).
- For more information about Anonymization, refer to the [Protegrity AI Developer Edition documentation](https://docs.protegrity.com/anonymization/2.0.0/docs/).
...
--placeholder for demos and blogs--
