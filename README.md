...
#### 4. Synthetic Data using Jypyter Notebook
A Jupyter Notebook is provided as a demonstration for Protegrity Synthetic Data.
Perform below steps to run the sample:
1. Install the required dependencies.It is recommended to install and activate the Python virtual environment.
   ```
...
2. Launch the jupyter server. 
    ...
    jupyter lab
    ```
Follow the steps in the notebook `samples/python/sample-synthetic-data/Synthetic Data.ipynb` to explore the synthetic data capabilities.
