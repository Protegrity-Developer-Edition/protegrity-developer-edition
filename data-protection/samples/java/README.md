...
The project uses:
- **Application Protector Java** (`com.protegrity:application-protector-java:1.1.0`)
  - Core data protection SDK
- **Protegrity Developer Edition** (`com.protegrity:protegrity-ai-developer-edition:1.1.0`)
...
- [GitHub Repository](https://github.com/Protegrity-AI-Developer-Edition/protegrity-ai-developer-java)
