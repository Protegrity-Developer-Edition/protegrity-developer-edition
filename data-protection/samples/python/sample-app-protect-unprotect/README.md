...
[![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/Protegrity-Developer-Edition/protegrity-ai-developer-edition/main?filepath=data-protection/samples/python/sample-app-protect-unprotect/getting-started-protection.ipynb)

## 2-Minute to First API Call

This interactive Jupyter notebook provides the fastest way to make your first Protegrity Protection API call. No local setup required—just click the Binder badge above or click [here](https://mybinder.org/v2/gh/Protegrity-Developer-Edition/protegrity-ai-developer-edition/main?filepath=data-protection/samples/python/sample-app-protect-unprotect/getting-started-protection.ipynb) to launch a browser-based environment.
