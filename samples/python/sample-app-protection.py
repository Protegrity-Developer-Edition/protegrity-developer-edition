...
def create_parser():
    ...
    parser = argparse.ArgumentParser(
        ...
        python sample-app-protection.py --input_data "e7087f449913bca6471e2b3209166dbb" --policy_user superuser --data_element text --dec
        python sample-app-protection.py --input_data "ELatin1_S+NSABC¹º»¼½¾¿ÄÅÆÇÈAlice1234567Bob" --policy_user superuser --data_element fpe_latin1_alphanumeric --protect
        python sample-app-protection.py --input_data "VðÈuXñ5_À+Áîg1ÿ¹º»¼½¾¿12ÔP1ëÕÖlgxÏHóFÚ6O3W" --policy_user superuser --data_element fpe_latin1_alphanumeric --unprotect
        python sample-app-protection.py --input_data "John Smith" --policy_user hr --data_element mask --unprotect
        python sample-app-protection.py --input_data "John Smith" --policy_user superuser --data_element no_encryption --protect
        python sample-app-protection.py --input_data "John Smith" --policy_user superuser --data_element no_encryption --unprotect
        """,
    )
