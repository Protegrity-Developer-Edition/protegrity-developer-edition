...
[![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/Protegrity-AI-Developer-Edition/protegrity-ai-developer-edition/main?filepath=data-protection/samples/python/sample-app-protect-unprotect/getting-started-protection.ipynb)

## 2-Minute to First API Call

This interactive Jupyter notebook provides the fastest way to make your first Protegrity Protection API call. No local setup required—just click the Binder badge above or click [here](https://mybinder.org/v2/gh/Protegrity-AI-Developer-Edition/protegrity-ai-developer-edition/main?filepath=data-protection/samples/python/sample-app-protect-unprotect/getting-started-protection.ipynb) to launch a browser-based environment.
...
3. Launch Jupyter:
   ```bash
   jupyter notebook data-protection/samples/python/sample-app-protect-unprotect/getting-started-protection.ipynb
   ```
...
- **GitHub Discussions:** [https://github.com/orgs/Protegrity-AI-Developer-Edition/discussions](https://github.com/orgs/Protegrity-AI-Developer-Edition/discussions)
